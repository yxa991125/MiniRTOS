...
- 开发版文档包括：`DEVELOPER_GUIDE.md`、`USER_GUIDE.md`、`Prompt.md`、`DEVELOPMENT_PLAN.md`、`SERIAL_FEEDBACK_ANALYSIS.md`、`CODEX_LOG.md` 以及本文件。
- 未执行的测试不能写成已通过。
...
4. `USER_GUIDE.md`
5. 本文件 `PROJECT_CONTEXT.md`
6. 与当前任务直接相关的源码文件
7. 如涉及历史问题，再看 `CODEX_LOG.md` 或 `SERIAL_FEEDBACK_ANALYSIS.md`
...
接手后先读 README.md、TESTING.md、DEVELOPER_GUIDE.md、USER_GUIDE.md、PROJECT_CONTEXT.md，再进入相关源码。
```

## 14. 本文档的使用边界
- 本文档不是发布说明，不替代 `README.md`。
- 本文档不是详细源码手册，不替代 `DEVELOPER_GUIDE.md`。
