...
## 输出
- `app_smoke_runs/<timestamp>_<board>/session.log`
- `app_smoke_runs/<timestamp>_<board>/summary.csv`
- `app_smoke_runs/<timestamp>_<board>/summary.json`
- `app_smoke_runs/<timestamp>_<board>/smoke_meta.json`
